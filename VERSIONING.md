...
目前產品版本：`v0.29.0`。`0.x` 代表 Beta，功能與資料契約仍可能調整；目前網站公開存取。

`VERSION` 是產品版本的主要來源；發布時必須同步更新 `package.json` 與 `package-lock.json` 的根套件版本，以及 README、PRD、Roadmap、開發紀錄與版本紀錄中的版本標示。
